...
export default function Footer() {
    return <footer className="mt-60 md:pl-20 px-5 md:px-20 xl:pr-60 flex flex-col md:flex-row w-full py-32 bg-burnt text-white dark:bg-night justify-center md:justify-between items-center">
